...
public class DataBaseHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_NAME = "cashculator.db";
	...
	public static final String TABLE_FRIENDS_EXPENSES="friends_expenses";
	...
	private void dropAll(SQLiteDatabase db) {
		...
		db.execSQL("DROP TABLE IF EXISTS " + TABLE_FRIENDS_EXPENSES);
	}
	...
	private void createV1(SQLiteDatabase db) {
		...
		sql = "CREATE TABLE " + TABLE_FRIENDS_EXPENSES + "(" +
				COLUMN_ID + " integer primary key autoincrement, " +
				COLUMN_NAME + " text not null, " +
				COLUMN_PHONE + " text not null, " +
				COLUMN_AMOUNT + " integer not null, " +
