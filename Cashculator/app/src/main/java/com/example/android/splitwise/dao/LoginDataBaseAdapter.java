...
import com.example.android.splitwise.DataBaseHelperLogin;
...
public class LoginDataBaseAdapter {
    ...
    {
        context = _context;
        dbHelper = new DataBaseHelperLogin(context, DATABASE_NAME, null, DATABASE_VERSION);
    }
    ...
    public int getCount(){
        Cursor cursor=db.rawQuery("Select count(*) from LOGIN",null);
        cursor.moveToFirst();
